...
class DepartmentService {
    ...
    //pinia with sort
    async getAllDepartments(page = 1, limit = 5, sortColumn = 'createAt', sortOrder = 'asc', search = '') {
        const skip = (page - 1) * limit;
        ...
        const departmentsWithEmployeeCount = await Promise.all(data.map(async (dept) => {
