...
class DepartmentController {
  ...
  async getDepartmentById(req, res, next) {
    try {
      ...
      return next(
        new ApiError(500, "An error occurred while retrieving department")
      );
    }
  }
  ...
  async updateDepartment(req, res, next) {
    try {
      ...
      return next(
        new ApiError(500, "An error occurred while updating department")
      );
    }
  }
  ...
  async deleteDepartment(req, res, next) {
    try {
      ...
      return next(
        new ApiError(500, "An error occurred while deleting department")
      );
    }
  }
}
